...
volatile int8_t 	I2CTX[I2C_RX_LEN];
...
#endif
{
	  switch(__even_in_range(UCB0IV, USCI_I2C_UCBIT9IFG))
	  {
	    ...
	    case USCI_I2C_UCRXIFG0:                 // Vector 22: RXIFG0
		 if(cMode & I2C_POLL)
		 {
		  	  //application will take care of receiving the data
		   	  __no_operation();
		 }
		 else
		 {
	    ...
	    case USCI_I2C_UCTXIFG0:  		        // Vector 24: TXIFG0
	      if(cMode & I2C_POLL)
	      {
	    	  //application will take care of sending the data
	    	  __no_operation();
	      }
	      else
	      {
